...
pmd({
  ...
  async (from, Gifted, conText) => {
    const { q, mek, reply, react, sender, botPic, botName, botFooter, newsletterUrl, newsletterJid, pmdJson, pmdBuffer, formatAudio, GiftedTechApi, GiftedApiKey } = conText;
...
pmd({
  ...
  async (from, Gifted, conText) => {
    const { q, mek, reply, react, sender, botPic, botName, botFooter, newsletterUrl, newsletterJid, pmdJson, pmdBuffer, formatVideo, GiftedTechApi, GiftedApiKey } = conText;
