/**
 * NICK WhatsApp Bot (Anti-Crash Version)
 * Creator: NICK
 * Improvements: auto-reconnect, error guards, keep-alive, safe plugins
 */

console.clear()
console.log("📳 Starting NICK-MD...")
...
║ 📞 DEV NO : NICK
╚════════════════╝`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/ru1ud6.jpg` }, caption: up })
...
setInterval(async () => {
    if (config.AUTO_BIO === "true") {
        ...
        const bioText = `❤️ nick xᴍᴅ ʙᴏᴛ 🤖 ɪs ʟɪᴠᴇ ɴᴏᴡ\n📅 ${date}\n⏰ ${time}`;
        try {
